                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="form-group col-12">
                                        ...
                                        <img id="picture" alt="image" src="{{ asset(Auth::user()->image) }}"
                                         style="width: 100px; height:100px" class="object-cover aspect-video">
                                        @else
                                        <img id="picture" alt="image" src="{{ asset('backend/assets/img/avatar/avatar-1.png')}}"
                                         style="width: 100px; height:100px" class="object-cover aspect-video">
                                        @endisset

                                        <input type="file" name="image" class="form-control mt-2" onchange="cambiarImagen(event)">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-12">
