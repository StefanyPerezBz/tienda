...
return [
    ...
    'attributes'           => [
        ...
        'shop_email'               => 'correo electrónico de la tienda',
        'shop_website'             => 'sitio web de la tienda',
        'shop_facebook'            => 'Facebook de la tienda',
        'shop_twitter'             => 'Twitter de la tienda',
        'shop_instagram'           => 'Instagram de la tienda',
        'shop_youtube'             => 'YouTube de la tienda',
        'shop_linkedin'            => 'LinkedIn de la tienda',
        'shop_pinterest'           => 'Pinterest de la tienda',
        'shop_tiktok'              => 'TikTok de la tienda',
        'shop_snapchat'            => 'Snapchat de la tienda',
        'shop_whatsapp'            => 'WhatsApp de la tienda',
        'shop_telegram'            => 'Telegram de la tienda',
        'shop_viber'               => 'Viber de la tienda',
        'shop_skype'               => 'Skype de la tienda',
        'shop_vkontakte'           => 'VKontakte de la tienda',
        'shop_twitch'              => 'Twitch de la tienda',
        'shop_discord'             => 'Discord de la tienda',
        'shop_reddit'              => 'Reddit de la tienda',
        'shop_medium'              => 'Medium de la tienda',
        'shop_tumblr'              => 'Tumblr de la tienda',
        'shop_flickr'              => 'Flickr de la tienda',
        'shop_behance'             => 'Behance de la tienda',
        'shop_dribbble'            => 'Dribbble de la tienda',
        'shop_deviantart'          => 'DeviantArt de la tienda',
        'shop_github'              => 'GitHub de la tienda',
        'nueva_llegada'            => 'nueva llegada',
        'destacado'                => 'destacado',
        'producto_top'             => 'producto top',
        'mejor_producto'           => 'mejor producto',
        'active'                   => 'activo',
        'inactive'                 => 'inactivo',
        'Si'                       => 'Sí',
        'No'                       => 'No',
        ...
        'offer_end_date'           => 'fecha de finalización de la oferta',
        ...
        'is_approved'              => 'es aprobado',
        'brand_id'                 => 'ID de la marca',
        'category_id'              => 'ID de la categoría',
        'sub_category_id'          => 'ID de la subcategoría',
        'child_category_id'        => 'ID de la subcategoría secundaria',
